...
<head>
    ...
    <link rel="stylesheet" href="/blc-delivery/css/player_style.css">
    ...
    <script src="/blc-delivery/public/js/simulationFunction.js"></script>
    <script src="/blc-delivery/js/script.js"></script>
...
<body>
    <div class="wrapper">
        @include('partials.player_sidebar_room')
        <div class="main">
            @yield('container')
        </div>
    </div>
