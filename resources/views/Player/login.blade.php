...
<head>
    ...
    <style>
        body {
            background: url('assets/background_login_player.png') no-repeat center center fixed;
        ...
        <div class="login-container">
            ...
            <form action='/loginPlayer' method="post">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="player_username" name="player_username" placeholder="Username" required>
                    <label for="player_username">Username</label>
                </div>
                <div class="form-floating mb-3">
